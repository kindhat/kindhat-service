 ...
 * on 2015-04-27 at 21:55:58 UTC 
 * Modify at your own risk.
 */

package com.kindhat.service.response.item.responseitemendpoint;

/**
 * Service definition for Responseitemendpoint (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link ResponseitemendpointRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class Responseitemendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the responseitemendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "responseitemendpoint/v1/";
   ...
   * @since 1.7
   */
  public Responseitemendpoint(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  Responseitemendpoint(Builder builder) {
    super(builder);
  }
   ...
   *
   * This request holds the parameters needed by the responseitemendpoint server.  After setting any
  ...
  public class GetItem extends ResponseitemendpointRequest<com.kindhat.service.response.item.responseitemendpoint.model.Item> {
     ...
     * Create a request for the method "getItem".
     *
     * This request holds the parameters needed by the the responseitemendpoint server.  After setting
     * any optional parameters, call the {@link GetItem#execute()} method to invoke the remote
     * operation. <p> {@link
    ...
    protected GetItem(java.lang.Long id) {
      super(Responseitemendpoint.this, "GET", REST_PATH, null, com.kindhat.service.response.item.responseitemendpoint.model.Item.class);
   ...
   *
   * @param content the {@link com.kindhat.service.response.item.responseitemendpoint.model.Item}
   * @return the request
   */
  public InsertItem insertItem(com.kindhat.service.response.item.responseitemendpoint.model.Item content) throws java.io.IOException {
    InsertItem result = new InsertItem(content);
    initialize(result);
    return result;
  }

  public class InsertItem extends ResponseitemendpointRequest<com.kindhat.service.response.item.responseitemendpoint.model.Item> {
     ...
     *
     * This request holds the parameters needed by the the responseitemendpoint server.  After setting
     * any optional parameters, call the {@link InsertItem#execute()} method to invoke the remote
     * operation. <p> {@link
     ...
     * @since 1.13
     */
    protected InsertItem(com.kindhat.service.response.item.responseitemendpoint.model.Item content) {
      super(Responseitemendpoint.this, "POST", REST_PATH, content, com.kindhat.service.response.item.responseitemendpoint.model.Item.class);
    }
  ...
  public class ListItem extends ResponseitemendpointRequest<com.kindhat.service.response.item.responseitemendpoint.model.CollectionResponseItem> {
     ...
     *
     * This request holds the parameters needed by the the responseitemendpoint server.  After setting
     * any optional parameters, call the {@link ListItem#execute()} method to invoke the remote
     * operation. <p> {@link
     ...
     */
    protected ListItem() {
      super(Responseitemendpoint.this, "GET", REST_PATH, null, com.kindhat.service.response.item.responseitemendpoint.model.CollectionResponseItem.class);
    }
   ...
   * @return the request
   */
  public UpdateItem updateItem(com.kindhat.service.response.item.responseitemendpoint.model.Item content) throws java.io.IOException {
    UpdateItem result = new UpdateItem(content);
    initialize(result);
    return result;
  }

  public class UpdateItem extends ResponseitemendpointRequest<com.kindhat.service.response.item.responseitemendpoint.model.Item> {
     ...
     *
     * This request holds the parameters needed by the the responseitemendpoint server.  After setting
     * any optional parameters, call the {@link UpdateItem#execute()} method to invoke the remote
     * operation. <p> {@link
     ...
     * @since 1.13
     */
    protected UpdateItem(com.kindhat.service.response.item.responseitemendpoint.model.Item content) {
      super(Responseitemendpoint.this, "PUT", REST_PATH, content, com.kindhat.service.response.item.responseitemendpoint.model.Item.class);
    }
  ...
  /**
   * Builder for {@link Responseitemendpoint}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link Responseitemendpoint}. */
    @Override
    public Responseitemendpoint build() {
      return new Responseitemendpoint(this);
    }
    ...
    /**
     * Set the {@link ResponseitemendpointRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setResponseitemendpointRequestInitializer(
        ResponseitemendpointRequestInitializer responseitemendpointRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(responseitemendpointRequestInitializer);
    }
