...
public final class User extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Key> requests;
   ...
   * @since 1.14
   */
  public User encodeImage(byte[] image) {
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Key> getRequests() {
    return requests;
  }
   ...
   */
  public User setRequests(java.util.List<Key> requests) {
   ...
   */
  public User setResponses(java.util.List<Key> responses) {
