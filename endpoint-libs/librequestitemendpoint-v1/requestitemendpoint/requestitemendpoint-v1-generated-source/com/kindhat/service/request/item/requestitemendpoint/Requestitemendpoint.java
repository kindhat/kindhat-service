...
package com.kindhat.service.request.item.requestitemendpoint;

/**
 * Service definition for Requestitemendpoint (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link RequestitemendpointRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class Requestitemendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the requestitemendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "requestitemendpoint/v1/";
   ...
   * @since 1.7
   */
  public Requestitemendpoint(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  Requestitemendpoint(Builder builder) {
    super(builder);
  }
   ...
   *
   * This request holds the parameters needed by the requestitemendpoint server.  After setting any
  ...
  public class GetItem extends RequestitemendpointRequest<com.kindhat.service.request.item.requestitemendpoint.model.Item> {
     ...
     * Create a request for the method "getItem".
     *
     * This request holds the parameters needed by the the requestitemendpoint server.  After setting
    ...
    protected GetItem(java.lang.Long id) {
      super(Requestitemendpoint.this, "GET", REST_PATH, null, com.kindhat.service.request.item.requestitemendpoint.model.Item.class);
   ...
   *
   * @param content the {@link com.kindhat.service.request.item.requestitemendpoint.model.Item}
   * @return the request
   */
  public InsertItem insertItem(com.kindhat.service.request.item.requestitemendpoint.model.Item content) throws java.io.IOException {
    InsertItem result = new InsertItem(content);
    initialize(result);
    return result;
  }

  public class InsertItem extends RequestitemendpointRequest<com.kindhat.service.request.item.requestitemendpoint.model.Item> {
     ...
     * @since 1.13
     */
    protected InsertItem(com.kindhat.service.request.item.requestitemendpoint.model.Item content) {
      super(Requestitemendpoint.this, "POST", REST_PATH, content, com.kindhat.service.request.item.requestitemendpoint.model.Item.class);
    }
  ...
  public class ListItem extends RequestitemendpointRequest<com.kindhat.service.request.item.requestitemendpoint.model.CollectionResponseItem> {
     ...
     */
    protected ListItem() {
      super(Requestitemendpoint.this, "GET", REST_PATH, null, com.kindhat.service.request.item.requestitemendpoint.model.CollectionResponseItem.class);
    }
   ...
   * @return the request
   */
  public UpdateItem updateItem(com.kindhat.service.request.item.requestitemendpoint.model.Item content) throws java.io.IOException {
    UpdateItem result = new UpdateItem(content);
    initialize(result);
    return result;
  }

  public class UpdateItem extends RequestitemendpointRequest<com.kindhat.service.request.item.requestitemendpoint.model.Item> {
     ...
     * @since 1.13
     */
    protected UpdateItem(com.kindhat.service.request.item.requestitemendpoint.model.Item content) {
      super(Requestitemendpoint.this, "PUT", REST_PATH, content, com.kindhat.service.request.item.requestitemendpoint.model.Item.class);
    }
  ...
  /**
   * Builder for {@link Requestitemendpoint}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link Requestitemendpoint}. */
    @Override
    public Requestitemendpoint build() {
      return new Requestitemendpoint(this);
    }
    ...
    /**
     * Set the {@link RequestitemendpointRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setRequestitemendpointRequestInitializer(
        RequestitemendpointRequestInitializer requestitemendpointRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(requestitemendpointRequestInitializer);
    }
